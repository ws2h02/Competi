...
public class TictactoeResource {
    Logger logger = LoggerFactory.getLogger(TictactoeResource.class);

   @RequestMapping(value = "tic-tac-toe",method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
